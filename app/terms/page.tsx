                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Somovibe, you accept and
                                agree to be bound by these
                                Terms of Service. If you do
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Teachers receive 75% of the
                                sale price for each material
                                sold. Somovibe retains 25%
                                to cover platform costs,
                                payment processing, and
                                maintenance. Payments are
                                processed through M-Pesa.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                All sales are final. Due to
                                the digital nature of our
                                products, we do not offer
                                refunds once a material has
                                been downloaded. Please
                                review material descriptions
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Teachers retain ownership of
                                their uploaded materials. By
                                uploading, you grant
                                Somovibe a license to
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                terms or engage in
                                fraudulent activity.
                                Teachers may have materials
                                removed if they fail to meet
                                quality standards.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Somovibe is provided "as is"
                                without warranties. We are
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                any time. Continued use of
                                the platform after changes
