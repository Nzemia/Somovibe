    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <div className="text-center space-y-2">
                ...
                <h1 className="text-3xl font-bold text-gray-900">Welcome to Questy</h1>
                <p className="text-gray-600">CBC Learning Management System</p>
            </div>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">New to Questy?</span>
                </div>
            </div>
