        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative flex-col justify-between p-12 overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(135deg, rgba(0,26,13,0.93) 0%, rgba(0,77,37,0.85) 60%, rgba(0,140,67,0.75) 100%)"
                    }}
                />
                ...
                <div className="relative z-10 space-y-8">
                    <div>
                        <h2 className="text-3xl xl:text-4xl font-extrabold text-white leading-tight mb-4">
                            Turn your CBC expertise
                            <br />
                            into monthly income.
                        </h2>
                        <p className="text-white/70 text-base xl:text-lg leading-relaxed max-w-md">
                            Upload your notes once. Earn 75%
                            on every sale — while students
                            across Kenya access quality
                ...
                <div className="relative z-10 text-white/30 text-xs">
                    © {new Date().getFullYear()} Somovibe ·
                    Kenya&apos;s CBC Marketplace
                </div>
            </div>
