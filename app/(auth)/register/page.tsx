...
function checkPasswordStrength(password: string): { strength: string; color: string; message: string } {
    if (password.length === 0) return { strength: "", color: "", message: "" };
    ...
    if (score <= 2) return { strength: "Weak", color: "text-red-500", message: "Add uppercase, numbers, and symbols" };
    if (score === 3) return { strength: "Fair", color: "text-orange-500", message: "Consider adding more characters" };
    if (score === 4) return { strength: "Good", color: "text-yellow-500", message: "Almost there!" };
    return { strength: "Strong", color: "text-green-500", message: "Great password!" };
}
                        ...
                        {password && (
                            <div className="space-y-1">
                                ...
                                <div className="h-1 bg-muted rounded-full overflow-hidden">
                                    <div
                                        className={`h-full transition-all ${passwordStrength.strength === "Weak" ? "w-1/4 bg-red-500" :
                                            passwordStrength.strength === "Fair" ? "w-1/2 bg-orange-500" :
