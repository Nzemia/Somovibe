...
export default async function AdminWalletPage() {
    ...
    // Fetch wallet data with withdrawal requests
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {transactions.map((transaction: Transaction) => {
                                            // Match DEBIT transactions to withdrawal requests by amount
                                            // and closest timestamp, using a consumed set to avoid double-matching
                                            const withdrawal = transaction.type === "DEBIT"
                                                ? withdrawalRequests.find(w =>
                                            ...
                                            return (
                                                <TableRow key={transaction.id}>
                                                    ...
                                                    <TableCell className="text-muted-foreground">
                                                        {withdrawal ? (
                                                            <span className="font-mono text-sm">{withdrawal.phone}</span>
                                                        ) : (
