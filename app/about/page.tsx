                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="bg-card border border-border rounded-lg p-8 mb-8">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Somovibe is dedicated to
                            revolutionizing access to
                            quality CBC learning materials
                            in Kenya. We connect verified
                            teachers with students, creating
                            a marketplace where knowledge is
                            shared, and educators are fairly
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Verified teachers upload
                                    quality CBC materials
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Our team reviews and
                                    approves quality content
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex items-start space-x-2">
                                ...
                                <span>
                                    ...
                                    We ensure all materials
                                    meet high educational
                                    standards
                                </span>
                            </li>
                            <li className="flex items-start space-x-2">
