            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 border-t border-gray-100 hover:bg-[#f5faf7] transition-colors">
                      ...
                      <span className="text-sm font-semibold text-gray-800">Toggle Theme</span>
                    </div>
                    */}
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold text-red-600 hover:bg-red-50 transition-colors disabled:opacity-60 border-t border-gray-100"
                                        >
                                            <svg
                                                className="w-4 h-4"
                                                fill="none"
