        ...
        >
            ...
            >
                ...
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                    To sell your CBC teaching materials, you
                    need a verified teacher account. It only
                    costs{" "}
                    <span className="text-[#008c43] font-bold">
                        KES 100
                    </span>{" "}
...
export function QuickNav({
    ...
    const isLoggedIn = Boolean(userRole || session?.user)
    ...
    const homeHref =
        homeToDashboard && isLoggedIn ? dashboardHref : "/"
    const homeActiveOn =
