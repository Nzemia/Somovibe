...
export function HeroSection() {
  return (
    <section
      ...
      style={{ height: "calc(100dvh - 7.5rem)", minHeight: "480px" }}
    >
      {/* Background image */}
      <Image
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(0, 140, 67, 0.20)" }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-8 max-w-3xl mx-auto w-full gap-5 sm:gap-6">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight drop-shadow-xl">
          ...
          <span className="relative inline-block">
            <span className="relative z-10">KSh 50,000+</span>
        ...
        <p className="text-white/90 text-sm sm:text-lg md:text-xl leading-relaxed max-w-2xl drop-shadow-md">
          Thousands of parents across Kenya are actively searching for CBC notes —{" "}
          <strong className="text-white">your notes</strong>. Upload once, share your link,
          and earn 75% on every sale while you sleep.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto justify-center pt-1">
          ...
          >
            <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
            </svg>
            I want to Earn
          </button>
