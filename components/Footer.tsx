...
export function Footer() {
  ...
  return (
    <footer className="bg-[#004d25] text-white">
      {/* Top wave divider */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-white/65 leading-relaxed max-w-sm text-sm sm:text-base">
              Kenya&apos;s premier educational marketplace. Quality CBC learning
              materials from verified teachers — empowering students and
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "Become a Teacher", href: "/teacher-register" },
